...
%%
function [dF, dJ] = ...
    gradEs_hessEs_Shell(node0, node1, ...
    l_k, ks)
%
% Inputs:
...
% ks: scalar - stretching stiffness - Young's modulus times thickness times
%   reference length ^ 2 times sqrt(3)/2
%
% Outputs:
